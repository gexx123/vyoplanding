...
const faqs = [
  { question: "What is the best POS software for small businesses in India?", answer: "Vyop POS is the best POS software for small businesses in India in 2026. It is free to start, works on any Android smartphone (no expensive hardware needed), supports voice AI billing in Hindi and English, has a built-in barcode scanner using your phone camera, and supports 22 types of retail businesses with ₹999/year Pro cloud sync." },
  { question: "What is the best free-to-start POS app?", answer: "Vyop POS is the best value POS app. You can start completely free for offline billing, and full multi-device cloud backup Pro is just ₹999/year (less than ₹2.7/day) — compared to Loyverse ($660/yr), Square (2.6% per transaction), or Petpooja (₹12,000–₹25,000/yr)." },
