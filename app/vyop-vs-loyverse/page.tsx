...
export const metadata: Metadata = {
  ...
  description:
    "Compare Vyop vs Loyverse POS. Loyverse charges $5-$25/month for add-ons and lacks Indian GST, Hindi voice billing & UPI. Vyop offers everything free with voice AI and smartphone barcode POS.",
  alternates: { canonical: "/vyop-vs-loyverse" },
  openGraph: {
    title: "Vyop vs Loyverse POS | Free Indian POS Alternative",
    description: "Why Indian shopkeepers choose Vyop over Loyverse: ₹0 pricing, Hindi voice AI, GST compliance & UPI support.",
    url: "https://vyop.in/vyop-vs-loyverse",
  },
};

const comparison = [
  { feature: "Base Price", vyop: "₹0 (100% Free Forever)", loyverse: "$0 Basic Tier", better: "tie" },
  ...
  { feature: "Total Annual Cost (All Features)", vyop: "₹0/year", loyverse: "$660/year (₹55,000+)", better: "vyop" },
...
const faqs = [
  { question: "Is Loyverse POS really free?", answer: "Loyverse's basic POS is free, but critical features cost extra: Employee Management is $5/month, Advanced Inventory is $25/month, and Kitchen Display System is $25/month. With all features, Loyverse costs $660/year (₹55,000+). Vyop includes all of these features for ₹0." },
      ...
      <section className="pt-40 pb-20 px-6 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--text-secondary)] max-w-2xl mx-auto">
            ...
            <strong className="text-gray-900">Vyop gives you everything Loyverse charges for — plus Indian GST, Hindi voice billing, and UPI — all for ₹0.</strong>
          </p>
        </div>
        ...
        <div className="text-center bg-gray-900 text-white p-10 md:p-14 rounded-3xl mb-16">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-4">
            Get Everything Loyverse Charges For — Free
          </h2>
          <p className="text-gray-300 max-w-xl mx-auto mb-8 text-base md:text-lg">
            Download Vyop and get voice AI billing, GST compliance, barcode scanning, and advanced inventory — all for ₹0.
          </p>
