...
const shopFirebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_SHOP_FIREBASE_AUTH_DOMAIN || (process.env.NEXT_PUBLIC_SHOP_FIREBASE_PROJECT_ID ? `${process.env.NEXT_PUBLIC_SHOP_FIREBASE_PROJECT_ID}.firebaseapp.com` : undefined),
